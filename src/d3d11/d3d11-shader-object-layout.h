...
// Note: Pending data functionality has been removed from Slang.
// This structure now only handles primary binding offsets.

/// A representation of the offset at which to bind a shader parameter or sub-object
struct BindingOffset : SimpleBindingOffset
{
    // Only primary data offsets are now supported
    // Pending data functionality has been removed
