...
public:
    ...
    /// Get pending data offset (returns zero since pending data functionality is removed)
    SimpleBindingOffset getPendingDataOffset() const { return SimpleBindingOffset{}; }
